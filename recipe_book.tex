...
%% TODO: Flush out Oatmeal Chocolate Chip recipe.
\section{Oatmeal Chocolate Chips}\index{Oatmeal Chocolate Cookies}
...
\marginnote[25pt]{%
    ...
    \toprule
	    Brown Sugar & \unit[\nicefrac{1}{2}]{cup} \\
	    Butter & \unit[1]{cup} \\
	    Brown Sugar & \unit[1]{cup} \\
	    White Sugar & \unit[\nicefrac{1}{2}]{cup} \\
	    Eggs & \unit[2]{} \\
	    Vanilla Extract & \unit[2]{tsp.} \\
	    Baking Soda & \unit[1]{tsp.} \\
	    Salt & \unit[\nicefrac{1}{2}]{tsp} \\
	    Flour & \unit[1\nicefrac{1}{2}]{tsp} \\
	    Oats & \unit[3]{cups} \\
	    Chocolate Chips & \unit[1]{cup} \\
    \bottomrule
  \end{tabular}
}
\newthought{Put all the} ingredients into a bowl and mix thoroughly. Then put on a baking sheet and put in the over for 12 minutes at 315.

\begin{quote}
  Flatemate's girlfriend makes these all the time. Highly addictive.
\end{quote}
